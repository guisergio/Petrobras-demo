...
# ``petrobras_demo/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-petrobras-demo-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained model.
dbutils.widgets.text(
    "model_name", "gui_uc_dev.petrobras.petrobras-demo-model", label="Full (Three-Level) Model Name"
)
