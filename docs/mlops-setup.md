...
[ML Config](../petrobras_demo/resources/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore petrobras_demo/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://adb-2765026106725720.0.azuredatabricks.net#setting/accounts) and
  [prod workspace admin console](https://adb-722046131822061.1.azuredatabricks.net#setting/accounts). If
...
Follow the instructions in [petrobras-demo/resources/README.md](../petrobras_demo/resources/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../petrobras_demo/resources/README.md)  to propose, test, and deploy
