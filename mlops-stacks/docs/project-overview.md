...
```
mlops-stacks        <- Root directory. Both monorepo and polyrepo are supported.
│
├── petrobras_demo       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
