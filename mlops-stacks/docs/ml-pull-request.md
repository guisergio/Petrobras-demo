...
Opening a pull request will trigger a[workflow](../.github/workflows/petrobras-demo-run-tests.yml) 
...
* [Staging workspace registered model](https://adb-2765026106725720.0.azuredatabricks.net#mlflow/models/staging-petrobras-demo-model)
* [Prod workspace registered model](https://adb-722046131822061.1.azuredatabricks.net#mlflow/models/prod-petrobras-demo-model)
